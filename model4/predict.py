# predict.py
# Description: This file predicts whether an image previously experienced wildfire or not, provided as a command-line argument.
#
# Usage:
# $ python3 predict.py path/to/an/image
# Output:
# Wildfire probability: 0.99
...
if __name__ == "__main__":
    ...
    if os.path.isfile(img_path):
        ...
        print(f"Area susceptible to wildfire probability: {prob:.2f}")
    else:
